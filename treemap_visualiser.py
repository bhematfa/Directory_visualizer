...
class Visualiser:
    ...
    def render_display(self) -> None:
        ...
        try:
            subscreen = self.screen.subsurface((0, 0, self.width, self.height -
                                                self.font_height))
        except ValueError:
            return
...
if __name__ == '__main__':
    ...
    PATH_TO_VISUALISE = '/Users/faizaanbhemat/Downloads/csc148/' \
                        'assignments/a2/starter_code/example-directory'
    # enter a custom path here if you wish
